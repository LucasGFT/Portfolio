    ...
    <>
        <div className="info">
            ...
            <div className="contact">
                <div className="icons">
                    <a href="https://www.linkedin.com/in/lucas-gomes-filgueiras/">
                       <img src={linkedin} alt="Linkedin" />
                    </a>
                    <a href="https://github.com/LucasGFT">
                        <img src={github} alt="" />
                    </a>
                </div>
                    <a className="email" href="mailto:lucasgft200303@gmail.com">
